...
namespace StageBit\CustomCode\Controller\Adminhtml\Vendor;

use Unirgy\Dropship\Controller\Adminhtml\Vendor\AbstractVendor;
        ...
        if ( $this->getRequest()->getPost() ) {
            ...
            try {
                ...
                foreach ($data as $key => $value){
                    if(in_array($key , ['logo', 'company_photos'])) {
                        unset($data[$key]);
