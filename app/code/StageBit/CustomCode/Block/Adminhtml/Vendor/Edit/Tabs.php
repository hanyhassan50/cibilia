...
namespace StageBit\CustomCode\Block\Adminhtml\Vendor\Edit;
...
class Tabs extends WidgetTabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('vendornew_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('StageBit\CustomCode\Block\Adminhtml\Vendor\Edit\Tab\Vendornew')
                ->setVendorId($id)
                ->toHtml(),
        ));
