...
namespace {
    include_once __DIR__ . '/../../../../../../Dropship/Ui/ProductFormModifier.php';
}
...
class TierRates extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\AbstractModifier
{
    ...
    public function myArrayManager()
    {
        return $this->_hlp->getObj('\Magento\Framework\Stdlib\ArrayManager');
    }
    
    public function myLocator()
    {
        return $this->_hlp->getObj('\Magento\Catalog\Model\Locator\LocatorInterface');
    }
    ...
    {
        $tierRatesPath = $this->myArrayManager()->findPath(
            'udtiership_rates',
            $this->meta,
            null,
            'children'
        ...
        if ($tierRatesPath) {
            $this->meta = $this->myArrayManager()->merge(
                $tierRatesPath,
                $this->meta,
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'disabled' => false,
                        'sortOrder' =>
                            $this->myArrayManager()->get($tierRatesPath . '/arguments/data/config/sortOrder', $this->meta),
                    ],
                ],
            ],
            'children' => [
                            ...
                            'arguments' => [
                                'data' => [
                                    'config' => [
                                        ...
                                        'enableLabel' => true,
                                        'dataScope' => 'cost',
                                        'addbefore' => $this->myLocator()->getStore()
                                            ->getBaseCurrency()
                                            ->getCurrencySymbol(),
                                    ],
                                ],
