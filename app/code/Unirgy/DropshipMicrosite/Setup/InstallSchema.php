...
class InstallSchema  implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $connection->newTable($tableName)
            ...
            ->addColumn('billing_street', Table::TYPE_TEXT, self::TEXT_SIZE, ['nullable' => true])
            ->addColumn('billing_city', Table::TYPE_TEXT, 255, ['nullable' => true])
            ->addColumn('billing_zip', Table::TYPE_TEXT, 255, ['nullable' => true])
            ->addColumn('billing_region_id', Table::TYPE_INTEGER, 10, ['unsigned' => true,'nullable' => true])
            ->addColumn('billing_region', Table::TYPE_TEXT, 255, ['nullable' => true])
            ->addColumn('billing_country_id', Table::TYPE_TEXT, 2, ['nullable' => true])
