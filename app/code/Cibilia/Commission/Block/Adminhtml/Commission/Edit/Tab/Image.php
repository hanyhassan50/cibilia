<?php
namespace Cibilia\Commission\Block\Adminhtml\Commission\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'commission_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_commission_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Cibilia\Commission\Block\Adminhtml\Form\Element\Image'];
    }
}
