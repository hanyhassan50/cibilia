...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Cibilia_Commission::commission_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('commission')->getId()) {
            return __("Edit Commission '%1'", $this->escapeHtml($this->_coreRegistry->registry('commission')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('commission/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
