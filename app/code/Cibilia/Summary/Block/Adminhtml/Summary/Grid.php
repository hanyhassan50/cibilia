...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('locked_amount', [
            'header' => __('Locked Amount'),
            'index' => 'cibilian_id',
            'renderer' => 'Cibilia\Commission\Block\Adminhtml\Commission\Grid\Renderer\Locked',
            'type' => 'currency',
            'filter' => false
        ]);
        ...
        $this->addColumn(
            ...
            [
                ...
                'actions' => [
                    ...
                    [
                        'caption' => __('Locked History'),
                        'url' => [
                            'base' => 'commission/index/index',
                            'params' => ['store' => $this->getRequest()->getParam('store'),'lock' => 1]
                        ],
                        'field' => 'cibilian_id'
                    ],
                    [
