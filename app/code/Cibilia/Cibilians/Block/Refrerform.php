    ...
    extends \Magento\Framework\View\Element\Template
{
    ...
    public function getVendorRole()
    {
        $arrCollection = array();
        $objectManager =  \Magento\Framework\App\ObjectManager::getInstance();
        $arrCollection = $objectManager->create('Cibilia\Idproofs\Model\Idproof')->getVendorRole();
    ...
    public function getcompanyemployee()
    {
        $arrCollection = array();
        $objectManager =  \Magento\Framework\App\ObjectManager::getInstance();
        $arrCollection = $objectManager->create('Cibilia\Idproofs\Model\Idproof')->getcompanyemployee();
    ...
    public function getcompanytype()
    {
        $arrCollection = array();
        $objectManager =  \Magento\Framework\App\ObjectManager::getInstance();
        $arrCollection = $objectManager->create('Cibilia\Idproofs\Model\Idproof')->getcompanytype();
	...
	public function productcategories()
    {
        $arrCollection = array();
        $objectManager =  \Magento\Framework\App\ObjectManager::getInstance();
        $arrCollection = $objectManager->create('Cibilia\Idproofs\Model\Idproof')->productcategories();
    ...
    public function productsellplace(){
		$arrCollection = array();
        $objectManager =  \Magento\Framework\App\ObjectManager::getInstance();
        $arrCollection = $objectManager->create('Cibilia\Idproofs\Model\Idproof')->productsellplace();
    ...
    public function bestTimetocall()
    {
        $arrCollection = array();
        $objectManager =  \Magento\Framework\App\ObjectManager::getInstance();
        $arrCollection = $objectManager->create('Cibilia\Idproofs\Model\Idproof')->bestTimetocall();
