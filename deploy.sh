...
make_task_def(){
	task_template='[
		{
			"name": "sample-webapp-task-family",
	...
	task_def=$(printf "$task_template" "601297571984" "latest")
}

push_ecr_image(){
	eval $(aws ecr get-login --region us-east-1)
	docker push 601297571984.dkr.ecr.eu-west-1.amazonaws.com/circleci:latest
}
