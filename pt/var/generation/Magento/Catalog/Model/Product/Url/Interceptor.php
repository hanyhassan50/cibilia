...
class Interceptor extends \Magento\Catalog\Model\Product\Url implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\UrlFactory $urlFactory, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Framework\Filter\FilterManager $filter, \Magento\Framework\Session\SidResolverInterface $sidResolver, \Magento\UrlRewrite\Model\UrlFinderInterface $urlFinder, array $data = array())
    {
        $this->___init();
    ...
    public function getUrlInStore(\Magento\Catalog\Model\Product $product, $params = array())
    {
        ...
        if (!$pluginInfo) {
            return parent::getUrlInStore($product, $params);
        } else {
