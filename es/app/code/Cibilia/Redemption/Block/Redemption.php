 ...
 */
class Redemption extends \Magento\Framework\View\Element\Template
{
    /**
    ...
    protected function _getCollection()
    {
        ...
        if($this->_request->getParam('id')){
             $collection->addFieldToFilter('status',$this->_request->getParam('id'));  
        }
        return $collection;
    }
    ...
    public function getCollection()
    {
        if (is_null($this->_redemptionCollection)) {
            ...
            $this->_redemptionCollection->setOrder('updated_at','asc');
        }
