<?php
namespace Unirgy\DropshipMicrosite\Model\Store;

/**
 * Interceptor class for @see \Unirgy\DropshipMicrosite\Model\Store
 */
class Interceptor extends \Unirgy\DropshipMicrosite\Model\Store implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useVendorUrl');
        if (!$pluginInfo) {
            return parent::useVendorUrl($flag);
        } else {
            return $this->___callPlugins('useVendorUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetUseVendorUrl');
        if (!$pluginInfo) {
            return parent::resetUseVendorUrl();
        } else {
            return $this->___callPlugins('resetUseVendorUrl', func_get_args(), $pluginInfo);
        }
    }
