 ...
 * Summary data helper
 */
namespace Cibilia\Summary\Helper;
...
{
    /**
     * Path to store config where count of summary posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'summary/view/items_per_page';
    ...
    /**
     * Remove Summary item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cibilia\Summary\Model\Summary $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Summary Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Summary Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getSummaryPerPage()
    {
