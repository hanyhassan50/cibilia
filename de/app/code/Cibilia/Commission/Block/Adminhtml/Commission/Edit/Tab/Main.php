...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('commission_main_');
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'title',
                'label' => __('Commission Title'),
                'title' => __('Commission Title'),
                'required' => true,
        ...
        $this->_eventManager->dispatch('adminhtml_commission_edit_tab_main_prepare_form', ['form' => $form]);
