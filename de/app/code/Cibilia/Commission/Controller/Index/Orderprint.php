...
class Orderprint extends \Magento\Framework\App\Action\Action
{
	/**
     * @var PageFactory
     */
    ...
    {   
        ...
        $objOrder = $this->_objectManager->create('Magento\Sales\Model\Order')->load($this->getRequest()->getParam('order_id'));
