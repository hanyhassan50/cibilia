    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Cibilia\RedemptionModel\Redemption */
        ...
        $form->setHtmlIdPrefix('redemption_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_redemption_edit_tab_content_prepare_form', ['form' => $form]);
