    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'redemption_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_redemption_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Cibilia\Redemption\Block\Adminhtml\Form\Element\Image'];
    }
}
