...
/**
 * Commissions data helper
 */
namespace Cibilia\Commissions\Helper;
...
{
    /**
     * Path to store config where count of commissions posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'commissions/view/items_per_page';
    ...
    /**
     * Remove Commissions item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cibilia\Commissions\Model\Commissions $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Commissions Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Commissions Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCommissionsPerPage()
    {
