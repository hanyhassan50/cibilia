...
/**
 * cibilianpayout edit form main tab
 */
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Cibilia\CibilianpayoutModel\Cibilianpayout */
        ...
        $form->setHtmlIdPrefix('cibilianpayout_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_cibilianpayout_edit_tab_content_prepare_form', ['form' => $form]);
