...
/**
 * Cibilianpayout data helper
 */
namespace Cibilia\Cibilianpayout\Helper;
...
{
    /**
     * Path to store config where count of cibilianpayout posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'cibilianpayout/view/items_per_page';
     ...
     * @var string
     */
    const MEDIA_PATH    = 'Cibilianpayout';
    ...
    /**
     * Remove Cibilianpayout item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cibilia\Cibilianpayout\Model\Cibilianpayout $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Cibilianpayout Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Cibilianpayout Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCibilianpayoutPerPage()
    {
