...
/**
 * CibilianSummary data helper
 */
namespace Cibilia\CibilianSummary\Helper;
...
{
    /**
     * Path to store config where count of cibiliansummary posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'cibiliansummary/view/items_per_page';
     ...
     * @var string
     */
    const MEDIA_PATH    = 'CibilianSummary';
    ...
    /**
     * Remove CibilianSummary item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cibilia\CibilianSummary\Model\CibilianSummary $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for CibilianSummary Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for CibilianSummary Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCibilianSummaryPerPage()
    {
