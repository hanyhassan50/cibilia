...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getCibilianSummary()->getTitle());
    }
     ...
     */
    public function getCibilianSummary()
    {
        return $this->_coreRegistry->registry('current_cibiliansummary');
    }
    ...
    {
        return $this->getUrl('cibiliansummary/index/index');
    }
