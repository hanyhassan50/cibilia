...
/**
 * CibilianRedemption data helper
 */
namespace Cibilia\CibilianRedemption\Helper;
...
{
    /**
     * Path to store config where count of cibilianredemption posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'cibilianredemption/view/items_per_page';
     ...
     * @var string
     */
    const MEDIA_PATH    = 'CibilianRedemption';
    ...
    /**
     * Remove CibilianRedemption item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cibilia\CibilianRedemption\Model\CibilianRedemption $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for CibilianRedemption Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for CibilianRedemption Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCibilianRedemptionPerPage()
    {
