    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if (!$this->dataProcessor->validate($data)) {
                $this->_redirect('*/*/edit', ['cibilianredemption_id' => $model->getId(), '_current' => true]);
                return;
            }

            try {
                $imageHelper = $this->_objectManager->get('Cibilia\CibilianRedemption\Helper\Data');
            ...
            $this->_redirect('*/*/edit', ['cibilianredemption_id' => $this->getRequest()->getParam('cibilianredemption_id')]);
            return;
        }
        $this->_redirect('*/*/');
    }
