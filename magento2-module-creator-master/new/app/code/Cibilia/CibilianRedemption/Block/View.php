...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getCibilianRedemption()->getTitle());
    }
     ...
     */
    public function getCibilianRedemption()
    {
        return $this->_coreRegistry->registry('current_cibilianredemption');
    }
    ...
    {
        return $this->getUrl('cibilianredemption/index/index');
    }
