...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getCibilianCommission()->getTitle());
    }
     ...
     */
    public function getCibilianCommission()
    {
        return $this->_coreRegistry->registry('current_cibiliancommission');
    }
    ...
    {
        return $this->getUrl('cibiliancommission/index/index');
    }
