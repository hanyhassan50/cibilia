...
/**
 * CibilianCommission data helper
 */
namespace Cibilia\CibilianCommission\Helper;
...
{
    /**
     * Path to store config where count of cibiliancommission posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'cibiliancommission/view/items_per_page';
     ...
     * @var string
     */
    const MEDIA_PATH    = 'CibilianCommission';
    ...
    /**
     * Remove CibilianCommission item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cibilia\CibilianCommission\Model\CibilianCommission $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for CibilianCommission Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for CibilianCommission Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCibilianCommissionPerPage()
    {
