...
/**
 * Redemption data helper
 */
namespace Cibilia\Redemption\Helper;
...
{
    /**
     * Path to store config where count of redemption posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'redemption/view/items_per_page';
    ...
    /**
     * Remove Redemption item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cibilia\Redemption\Model\Redemption $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Redemption Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Redemption Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getRedemptionPerPage()
    {
