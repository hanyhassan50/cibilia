...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getRedemption()->getTitle());
    }
    ...
    {
        return $this->_coreRegistry->registry('current_redemption');
    }
    ...
    {
        return $this->getUrl('redemption/index/index');
    }
