...
/**
 * Commission data helper
 */
namespace Cibilia\Commission\Helper;
...
{
    /**
     * Path to store config where count of commission posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'commission/view/items_per_page';
    ...
    /**
     * Remove Commission item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cibilia\Commission\Model\Commissions $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Commission Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Commission Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCommissionPerPage()
    {
